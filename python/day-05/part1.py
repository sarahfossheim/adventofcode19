...
def process_data(values, input, getVals=False):
    ...
    while True:
        ...
        # GET NUMBER INDECES
        index_1 = values[index + 1] if mode_1 == 0 else index + 1
        index_2 = values[index + 2] if mode_2 == 0 else index + 2
        index_3 = values[index + 3] if mode_3 == 0 else index + 3
